...
class GeneralException extends Exception
{
    ...
    protected function getTechnicalDetails()
    {
        ...
        if (function_exists("sys_getloadavg")) {
            ...
            $cpu = number_format($stats[0], 2) . "%";
        }
        $details .= "CPU: $cpu" . $newLine;
        $details .= "Server: " . Util::getServerName() . $newLine;
    ...
    private function getRequestDetails()
    {
        ...
        if ($this->serverSettings && is_array($this->serverSettings) && count($this->serverSettings) > 0) {
            ...
            $details .= "HTTP_REFERRER = " . $this->serverSettings['HTTP_REFERER'] . $newLine;
