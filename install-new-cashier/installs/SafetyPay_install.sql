...
SET @processorName = 'SafetyPay';
SET @processorDisplayName = 'SafetyPay';
SET @isActive = 1;
...
VALUES
	(@lastGroupId, 'WSDL_url', 'https://mws2.safetypay.com/Sandbox/express/ws/v.3.0/?wsdl'),
