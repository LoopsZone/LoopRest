...
SET @processorName = 'WU_WAMPA';
SET @processorDisplayName = 'WU_WAMPA';
SET @isActive = 1;
...
(@lastGroupId, 'URL_WS', 'http://paybackup.com/webservice/service.asmx?WSDL');
...
VALUES (@processorId, '6');

-- ----------------------------------------
-- caP2PAgency --
-- ----------------------------------------
INSERT INTO caP2PAgency (caProcessor_Id, BackendName, ApiName, Destination) VALUES (@processorId, 'PayCR', 'MGAPI.docx', 'San José, Costa Rica');
...
('19', @processorName, 'WU_WAMPA|109'),
('20', @processorName, 'WU_WAMPA|109');