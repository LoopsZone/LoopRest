...
SET @processorName = 'WU_WEB_WND';
SET @processorDisplayName = 'WU_WEB_WND';
SET @isActive = 1;
...
VALUES
	(@lastGroupId, 'API_URL', 'https://www2.webperformance.mobi/services/ws.asmx?wsdl'),
	(@lastGroupId, 'BankName', 'WNDWU'),
...
VALUES 
	(@processorId, 'Web Wnd', 'webperformance webservices documentation', 'San José, Costa Rica', 1);
