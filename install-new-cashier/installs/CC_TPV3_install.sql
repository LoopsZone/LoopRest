...
SET @processorName = 'CC_TPV3';
SET @processorDisplayName = 'CC_TPV3';
SET @isActive = 1;
...
VALUES
	(@lastGroupId, 'API_URL', 'https://transactionsrv.vpos.com/gtw/process.php');
...
VALUES 
	('1', @processorId, 'vp_Account', '0'),
	('2', @processorId, 'vp_Password', '0'),
