...
SET @processorName = 'CC_RTCC_CAD';
SET @processorDisplayName = 'CC_RTCC_CAD';
SET @isActive = 1;
...
VALUES
	...
	(@lastGroupId, 'URL_API', 'https://secure.qwipi.com/universalS2S/payment'),
	(@lastGroupId, 'USE_NEW_API', '1');
