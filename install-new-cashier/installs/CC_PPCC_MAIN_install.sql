...
SET @processorName = 'CC_PPCC_MAIN';
SET @processorDisplayName = 'CC_PPCC_MAIN';
SET @isActive = 1;
...
VALUES
	(@lastGroupId, 'API_URL', 'https://www.pay-6du0c.com/qekizalw.php'),
	(@lastGroupId, 'METHODID', '1000'),
	(@lastGroupId, 'REFUND_METHODID', '7000'),
	(@lastGroupId, 'LANG', 'en'),
	(@lastGroupId, 'LISTID', '0'),
	(@lastGroupId, 'VIP', '1');
...
VALUES 
	(1, @processorId, 'Profile ID', 0),
	(2, @processorId, 'Password', 0),
	(3, @processorId, 'Site Name', 0),
