...
SET @processorName = 'Ria';
SET @processorDisplayName = 'Person 2 Person (RIA)';
SET @isActive = 1;
...
VALUES (1000260000, @processorId, @processorId, 'P2P', 'RIA Retiros', @isActive, 1, NOW(), 0);
...
-- caP2PAgency --
-- ----------------------------------------
INSERT INTO caP2PAgency (caProcessor_Id, BackendName, ApiName, Destination) VALUES (@processorId, 'Ria', NULL, NULL);
...
('19', @processorName, 'Ria|113'),
('20', @processorName, 'Ria|113');